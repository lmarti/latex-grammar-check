...
wb["function"] = function(a, b) {
  return jc.a ? jc.a(function() {
    if(h === Oa) {
      ...
      Oa.Ub = j;
      Oa.nc = function() {
        return O.b ? O.b("cljs.core/t3321") : O.call(l, "cljs.core/t3321")
      };
      Oa.oc = function(a, b) {
        return F(b, "cljs.core/t3321")
      };
      var c = function(a, b) {
...
function id(a, b) {
  var c = ha(a);
  (c ? b : c) ? (255 < ed && (dd = {}, ed = 0), c = dd[a], c == l && (c = ya(a), dd[a] = c, ed += 1)) : c = Eb(a);
  return c
}
gd = function(a, b) {
  switch(arguments.length) {
...
function le(a) {
  if(a) {
    var b = a.j & 134217728, a = (b ? b : a.md) ? j : a.j ? m : x(Ib, a)
  }else {
    a = x(Ib, a)
  }
  return a
...
function qe(a, b, c, d) {
  return Oc.a(Oc.a(Oc.a(Ed.c(Oc, K, le(d) ? Jb(d) : Ed.c(Oc, K, d)), c), b), a)
}
function re(a, b, c, d) {
  var f = l;
  t(d) && (f = N(Array.prototype.slice.call(arguments, 3), 0));
...
function $e(a, b, c) {
  ...
  var Ha = B(Ra), Cb = C(Ra);
  if(17 === b) {
    return a.Nb ? a.Nb(c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha) : a.Nb ? a.Nb(c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha) : a.call(l, c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha)
  }
  var Ra = B(Cb), Pd = C(Cb);
  if(18 === b) {
    return a.Ob ? a.Ob(c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha, Ra) : a.Ob ? a.Ob(c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha, Ra) : a.call(l, c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha, Ra)
  }
  Cb = B(Pd);
  Pd = C(Pd);
  if(19 === b) {
    return a.Pb ? a.Pb(c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha, Ra, Cb) : a.Pb ? a.Pb(c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha, Ra, Cb) : a.call(l, c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha, Ra, Cb)
  }
  var ig = B(Pd);
  C(Pd);
  if(20 === b) {
    return a.Qb ? a.Qb(c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha, Ra, Cb, ig) : a.Qb ? a.Qb(c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha, Ra, Cb, ig) : a.call(l, c, d, f, g, i, a, k, q, v, w, A, E, H, T, Q, ca, Ha, Ra, Cb, ig)
  }
...
function vf(a, b) {
  return new X(l, m, function() {
    ...
    if(c) {
      if(pd(c)) {
        for(var d = Zb(c), f = U(d), g = new Ae(Sa.b(f), 0), i = 0;;) {
          if(i < f) {
...
var Sf = function Rf(b, c) {
  return new X(l, m, function() {
    ...
    if(d) {
      if(pd(d)) {
        for(var f = Zb(d), g = U(f), i = new Ae(Sa.b(g), 0), k = 0;;) {
          if(k < g) {
...
var lg = function kg(b, c, d, f, g) {
  var i = new dg(d.v, d.g.slice());
  if(0 === c) {
    i.g[f & 31] = g
  }else {
    var k = f >>> c & 31, b = kg(b, c - 5, d.g[k], f, g);
    i.g[k] = b
  }
  return i
};
...
var tg = new dg(l, Sa.b(32)), sg = new mg(l, 0, 5, tg, [], 0);
function Y(a) {
  var b = a.length;
  if(32 > b) {
...
r.Ma = function(a, b) {
  if(this.root.v) {
    if(32 > this.k - eg(a)) {
      ...
      var c = new dg(this.root.v, this.Y), d = Sa.b(32);
      d[0] = b;
      this.Y = d;
...
r.Qa = function(a) {
  ...
  var b = Kd(this.Q), c = Sa.b(0 > b ? 4 : 2 * (b + 1));
  qd(this.g, 0, c, 0, 2 * b);
...
r.Qa = function(a) {
  ...
  var b = Sa.b(2 * (this.k + 1));
  qd(this.g, 0, b, 0, 2 * this.k);
  return new sh(a, this.ta, this.k, b)
};
r.ja = function(a, b, c, d, f) {
  return b === this.ta ? (a = rh(this.g, this.k, c), -1 === a ? (a = this.g.length, b = Sa.b(a + 2), qd(this.g, 0, b, 0, a), b[a] = c, b[a + 1] = d, f.p = j, new sh(l, this.ta, this.k + 1, b)) : M.a(this.g[a], d) ? this : new sh(l, this.ta, this.k, dh.c(this.g, a + 1, d))) : (new lh(l, 1 << (this.ta >>> a & 31), [l, this])).ja(a, b, c, d, f)
};
r.va = function(a, b, c, d) {
...
function pj(a) {
  ...
  var b;
  var c = nj[s(a == l ? l : a)];
  c ? b = c : (c = nj._) ? b = c : e(y("IEncodeClojure.-js->clj", a));
  return b.call(l, a)
}
function qj(a, b) {
  if(a ? a.Kc : a) {
  ...
  var c;
  var d = nj[s(a == l ? l : a)];
  d ? c = d : (d = nj._) ? c = d : e(y("IEncodeClojure.-js->clj", a));
  return c.call(l, a, b)
}
oj = function(a, b) {
  switch(arguments.length) {
...
oj.a = qj;
nj = oj;
var rj = l, rj = function(a, b) {
  switch(arguments.length) {
    case 1:
      return nj.a(a, Tg(["\ufdd0'keywordize-keys"], {"\ufdd0'keywordize-keys":m}));
    case 2:
...
var Aj, Bj = l;
function Cj(a, b) {
  return Bj.c($(a), b, "true")
}
function Dj(a, b, c) {
  return u(c) ? (a = $(a), a.setAttribute(pi(b), "\ufdd0'style" === b ? vj.a(" ", tf.a(function(a) {
...
function Ej(a, b, c, d) {
  ...
  for(b = G(R(Y([b, c]), Uf.a(2, d)));;) {
    if(b) {
      d = I(b), c = V.c(d, 0, l), d = V.c(d, 1, l), Bj.c(a, c, d), b = L(b)
    }else {
      break
    }
  }
...
Bj = function(a, b, c, d) {
  switch(arguments.length) {
    ...
    default:
      return Fj.e(a, b, c, N(arguments, 3))
  }
  e(Error("Invalid arity: " + arguments.length))
};
Bj.n = 3;
...
function Ij(a, b, c) {
  if("function" == typeof a.forEach) {
    ...
    if(ga(a) || ha(a)) {
      ...
      for(var d = Hj(a), f = Gj(a), g = f.length, i = 0;i < g;i++) {
...
;function Jj(a, b) {
  ...
  if(1 < c) {
    ...
    if(a) {
      a instanceof Jj ? (c = a.Sa(), d = a.pa()) : (c = Ja(a), d = Ia(a));
...
r.remove = function(a) {
  return Lj(this.qa, a) ? (delete this.qa[a], this.z--, this.Hc++, this.X.length > 2 * this.z && Kj(this), j) : m
};
function Kj(a) {
  if(a.z != a.X.length) {
  ...
  if(a.z != a.X.length) {
    for(var f = {}, c = b = 0;b < a.X.length;) {
      d = a.X[b], Lj(f, d) || (a.X[c++] = d, f[d] = 1), b++
    }
    a.X.length = c
  }
}
r.get = function(a, b) {
  return Lj(this.qa, a) ? this.qa[a] : b
};
r.set = function(a, b) {
  Lj(this.qa, a) || (this.z++, this.X.push(a), this.Hc++);
  this.qa[a] = b
};
r.Vb = function() {
  return new Jj(this)
...
function gk(a) {
  ...
  if(!(b = fk[a])) {
    b = 0;
    for(var c = ra(String(Zj)).split("."), d = ra(String(a)).split("."), f = Math.max(c.length, d.length), g = 0;0 == b && g < f;g++) {
...
;var jk = RegExp("^(?:([^:/?#.]+):)?(?://(?:([^/?#]*)@)?([\\w\\d\\-\\u0100-\\uffff.%]*)(?::([0-9]+))?)?([^?#]+)?(?:\\?([^#]*))?(?:#(.*))?$");
function kk(a, b, c) {
  this.ia = a || l;
  this.Tc = !!c
}
function lk(a) {
  if(!a.R && (a.R = new Jj, a.z = 0, a.ia)) {
...
function nk(a) {
  ...
  for(var c = new kk(l, 0, h), a = Gj(a), d = 0;d < b.length;d++) {
    var f = b[d], g = a[d];
    if("array" == s(g)) {
      var i = c;
      i.remove(f);
      0 < g.length && (i.ia = l, i.R.set(mk(i, f), Ga(g)), i.z += g.length)
    }else {
      c.add(f, g)
    }
  }
...
r.add = function(a, b) {
  lk(this);
  this.ia = l;
  var a = mk(this, a), c = this.R.get(a);
  c || this.R.set(a, c = []);
  c.push(b);
  this.z++;
  return this
...
r.pa = function(a) {
  ...
  var b = [];
  if(a) {
    this.Oa(a) && (b = Fa(b, this.R.get(mk(this, a))))
  }else {
...
var hl = Yi.b(Tg(["inst", "uuid", "queue"], {inst:function(a) {
  ...
  return td(a) ? new uj(a) : tk.e(l, N(["UUID literal expects a string as its representation."], 0))
}, queue:function(a) {
...
r.qb = function(a, b) {
  ...
  this.offsetX = Wj || a.offsetX !== h ? a.offsetX : a.layerX;
  this.offsetY = Wj || a.offsetY !== h ? a.offsetY : a.layerY;
  ...
  this.Xc = Yj ? a.metaKey : a.ctrlKey;
  this.state = a.state;
  this.tc = a;
  ...
  if(b in c) {
    ...
    if(b) {
      ...
      for(var i = f.length - 1;!a.Ta && 0 <= i && g.ga;i--) {
        a.currentTarget = f[i], d &= zl(g, f[i], a.type, j, a) && a.tb != m
      }
    }
    if(m in c) {
      if(g = c[m], g.ga = g.z, b) {
        for(i = 0;!a.Ta && i < f.length && g.ga;i++) {
          a.currentTarget = f[i], d &= zl(g, f[i], a.type, m, a) && a.tb != m
        }
      }else {
        for(f = this;!a.Ta && f && g.ga;f = f.Dc) {
          a.currentTarget = f, d &= zl(g, f, a.type, m, a) && a.tb != m
        }
      }
    }
    a = Boolean(d)
...
r.send = function(a, b, c, d) {
  ...
  this.Wb = m;
  this.Ga = j;
  this.D = this.Wa ? Yl(this.Wa) : Yl(Wl);
  this.xb = this.Wa ? this.Wa.kb || (this.Wa.kb = $l(this.Wa)) : Wl.kb || (Wl.kb = $l(Wl));
  this.D.onreadystatechange = na(this.Cc, this);
  try {
    Ql(this.aa, cm(this, "Opening Xhr")), this.Yb = j, this.D.open(b, a, j), this.Yb = m
  }catch(f) {
  ...
  try {
    this.Ea && (Cl.clearTimeout(this.Ea), this.Ea = l), 0 < this.ub && (Ql(this.aa, cm(this, "Will abort after " + this.ub + "ms if incomplete")), this.Ea = Cl.setTimeout(na(this.bd, this), this.ub)), Ql(this.aa, cm(this, "Sending request")), this.pb = j, this.D.send(a), this.pb = m
  }catch(i) {
    Ql(this.aa, cm(this, "Send error: " + i.message)), dm(this, i)
  }
};
r.bd = function() {
  "undefined" != typeof ba && this.D && (this.eb = "Timed out after " + this.ub + "ms, aborting", this.cb = 8, Ql(this.aa, cm(this, this.eb)), this.dispatchEvent("timeout"), this.abort(8))
};
function dm(a, b) {
  a.Ga = m;
...
r.abort = function(a) {
  this.D && this.Ga && (Ql(this.aa, cm(this, "Aborting")), this.Ga = m, this.ab = j, this.D.abort(), this.ab = m, this.cb = a || 7, this.dispatchEvent("complete"), this.dispatchEvent("abort"), fm(this))
};
r.Cc = function() {
  !this.Yb && !this.pb && !this.ab ? this.Wc() : gm(this)
};
r.Wc = function() {
  gm(this)
};
      ...
      if(a.pb && 4 == hm(a)) {
        ...
        if(a.dispatchEvent("readystatechange"), 4 == hm(a)) {
          ...
          try {
            ...
            d ? (a.dispatchEvent("complete"), a.dispatchEvent("success")) : (a.cb = 6, a.eb = jm(a) + " [" + im(a) + "]", em(a))
          }finally {
            fm(a)
          }
        }
...
;function mm(a) {
  ...
  return function(a) {
    ...
    i = jf(i, Y([200, 201, 202, 204, 205, 206]));
...
function om(a, b) {
  ...
  ul(d, "complete", f);
  return d.send(a, "POST", u(c) ? nk(new Jj(lj(c))).toString() : l)
}
function pm(a, b) {
  var c = l;
  t(b) && (c = N(Array.prototype.slice.call(arguments, 1), 0));
...
function rm(a) {
  ...
  var b;
  var c = rm[s(a == l ? l : a)];
  c ? b = c : (c = rm._) ? b = c : e(y("PElement.-elem", a));
  return b.call(l, a)
}
function sm(a, b) {
...
function tm(a) {
  var b = pi(a), c = sm(b, 0), a = document.createElement(0 < c ? b.substring(0, c) : 0 === c ? "div" : b);
  if(0 <= c) {
    for(b = b.substring(c);;) {
      var c = sm(b, 1), d = 0 <= c ? b.substring(0, c) : b, f = d.charAt(0);
      M.a("#", f) ? a.setAttribute("id", d.substring(1)) : M.a(".", f) ? zj(a, d.substring(1)) : e(Error([W("No matching clause: "), W(d.charAt(0))].join("")));
      if(0 <= c) {
        b = b.substring(c)
      }else {
        break
...
var vm, wm = l;
function xm(a) {
  return wm.a(document.createDocumentFragment(), a)
}
function ym(a, b) {
  if(b ? u(u(l) ? l : b.oa) || (b.Tb ? 0 : x(qm, b)) : x(qm, b)) {
    return a.appendChild(rm(b)), a
  }
  if(sd(b)) {
    for(var c = G(b);;) {
      if(c) {
...
vm = wm;
function $(a) {
  return(a ? u(u(l) ? l : a.oa) || (a.Tb ? 0 : x(qm, a)) : x(qm, a)) ? rm(a) : vm.b(a)
}
qm.string = j;
rm.string = function(a) {
  return ud(a) ? tm(a) : document.createTextNode("" + W(a))
};
qm.number = j;
rm.number = function(a) {
  return document.createTextNode("" + W(a))
};
mg.prototype.oa = j;
mg.prototype.Aa = function(a) {
  for(var b = V.c(a, 0, l), c = V.c(a, 1, l), a = Ld(a, 2), b = tm(b), d = nd(c), d = (d ? !(c ? u(u(l) ? l : c.oa) || (c.Tb ? 0 : x(qm, c)) : x(qm, c)) : d) ? c : l, c = u(d) ? a : R(c, a), a = G(d);;) {
    if(a) {
...
function zm(a) {
  return(a ? u(u(l) ? l : a.oa) || (a.Tb ? 0 : x(qm, a)) : x(qm, a)) ? rm(a) : um(a)
}
;!Uj || ik();
!Vj && !Uj || Uj && ik() || Vj && gk("1.9.1");
Uj && gk("9");
function Am(a) {
  var b = a.type;
  if(!t(b)) {
...
var Em = /<|&#?\w+;/, Fm = /^\s+/, Gm = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/i, Hm = /<([\w:]+)/, Im = /<tbody/i, Jm = Y([1, "<select multiple='multiple'>", "</select>"]), Km = Y([1, "<table>", "</table>"]), Lm = Y([3, "<table><tbody><tr>", "</tr></tbody></table>"]), Mm = Tg("col \ufdd0'default tfoot caption optgroup legend area td thead th option tbody tr colgroup".split(" "), {col:Y([2, "<table><tbody></tbody><colgroup>", "</colgroup></table>"]), "\ufdd0'default":Y([0, 
"", ""]), tfoot:Km, caption:Km, optgroup:Jm, legend:Y([1, "<fieldset>", "</fieldset>"]), area:Y([1, "<map>", "</map>"]), td:Lm, thead:Km, th:Lm, option:Jm, tbody:Km, tr:Y([2, "<table><tbody>", "</tbody></table>"]), colgroup:Km});
function Nm(a) {
  if(a ? a.Qc : a) {
    return a.Qc(a)
  }
  var b;
  var c = Nm[s(a == l ? l : a)];
  c ? b = c : (c = Nm._) ? b = c : e(y("DomContent.single-node", a));
  return b.call(l, a)
}
function Om() {
...
Nm._ = function(a) {
  if(a == l) {
    ...
    var b;
    b = a ? ((b = a.j & 8388608) ? b : a.Fb) || (a.j ? 0 : x(Fb, a)) : x(Fb, a);
    a = b ? I(a) : u(u(a) ? a.length : a) ? a.item(0) : a
  }
  return a
};
Nm.string = function(a) {
  var b = Nm, c;
  if(u(Ji(Em, a))) {
    td(Gm) ? c = a.replace(RegExp(String(Gm).replace(/([-()\[\]{}+?*.$\^|,:#<!\\])/g, "\\$1").replace(/\x08/g, "\\x08"), "g"), "<$1></$2>") : u(Gm.hasOwnProperty("source")) ? c = a.replace(RegExp(Gm.source, "g"), "<$1></$2>") : e([W("Invalid match arg: "), W(Gm)].join(""));
    var d = ("" + W(Nc(Ji(Hm, c)))).toLowerCase(), f = D.c(Mm, d, (new we("\ufdd0'default")).call(l, Mm)), a = V.c(f, 0, l), g = V.c(f, 1, l), f = V.c(f, 2, l);
    a: {
    ...
    g = (g = Pa(Cm)) ? Ji(Fm, c) : g;
    u(g) && (g = a, g.insertBefore(document.createTextNode(I(Ji(Fm, c))), g.firstChild));
    c = a.childNodes
  }else {
...
var an, bn = l;
function cn(a) {
  return bn.a(document, a)
}
function dn(a, b) {
  var c, d = $($(a)).querySelectorAll(Zm(b));
...
var en, fn = l;
function gn(a, b) {
  return I(Sf(an.b(b), $m($(a))))
}
function hn(a, b, c) {
  var d = $(a), a = $(b);
  return I(Sf(an.a(d, c), si(function(a) {
    return a !== d
  }, $m(a))))
}
fn = function(a, b, c) {
...
function mn(a, b, c) {
  a = $(a);
  return a.Rc = P.c(b, ln(a), c)
}
function nn(a, b, c) {
  var d = l;
  t(c) && (d = N(Array.prototype.slice.call(arguments, 2), 0));
  return mn.call(this, a, b, d)
}
nn.n = 2;
nn.h = function(a) {
  var b = I(a), c = I(L(a)), a = J(L(a));
...
function on(a, b) {
  ...
  for(var c = md(a) ? ti.a(function(a) {
    ...
    if(f) {
      for(var g = I(f), i = V.c(g, 0, l), g = V.c(g, 1, l), i = G(D.c(jn, i, $g([i], [lf])));;) {
        if(i) {
          var k = I(i), q = V.c(k, 0, l), k = V.c(k, 1, l), k = (u(c) ? mf.c(kn, d, c) : lf).call(l, k.b ? k.b(g) : k.call(l, g));
          nn.e(d, $f, N([Y([c, q, g]), k], 0));
...
pn.e = on;
var qn = $(document).querySelector("#container");
function rn() {
  return pm.e("/check-grammar", N([Tg(["\ufdd0'handler", "\ufdd0'params"], {"\ufdd0'handler":function(a) {
    return alert(a)
  }, "\ufdd0'params":Tg(["\ufdd0'latex-markup"], {"\ufdd0'latex-markup":Om()})})], 0))
}
function sn() {
  var a = Tg(["\ufdd0'lineNumbers", "\ufdd0'mode", "\ufdd0'tabMode"], {"\ufdd0'lineNumbers":j, "\ufdd0'mode":Tg(["\ufdd0'name"], {"\ufdd0'name":"stex"}), "\ufdd0'tabMode":"indent"}), b = zm(Y(["\ufdd0'textarea#latex-markup", "put some latex here to see it pretty printed"]));
  $(qn).appendChild($(b));
  CodeMirror.fromTextArea(b, lj(a));
  a = zm(Y(["\ufdd0'button#check-grammar", "Check Grammar"]));
  $(qn).appendChild($(a));
  return pn.e($(document).querySelector("#check-grammar"), N(["\ufdd0'click", rn], 0))
}
...
for(var vn;tn.length && (vn = tn.shift());) {
  !tn.length && t(sn) ? un[vn] = sn : un = un[vn] ? un[vn] : un[vn] = {}
}
;