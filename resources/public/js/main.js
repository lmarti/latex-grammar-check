...
function yn() {
  Um(Um(Um(qn, Im(X(["\ufdd0'textarea#latex-markup", "A sentence with a error in the Hitchhiker's Guide tot he Galaxy"]))), Im(X(["\ufdd0'div.span3", Y(["\ufdd0'class"], {"\ufdd0'class":"text-center"}), Im(X(["\ufdd0'div#buttons.btn-group", Im(X(["\ufdd0'a#check-grammar.btn", Im(X(["\ufdd0'i.icon-check"])), Im(X(["\ufdd0'span", " Check Grammar"]))])), Im(X(["\ufdd0'a#dumb-check-grammar.btn", "Dumb Check Grammar"])), Im(X(["\ufdd0'a#extract-text.btn", "Extract Text"]))]))]))), Im(X(["\ufdd0'table#check-grammar-result", 
  Y(["\ufdd0'class"], {"\ufdd0'class":"table table-condensed table-striped table-hover"})])));
